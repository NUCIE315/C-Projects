...
void array_testcase(int connfd) {
	...
	test_case(connfd, "SET Name LiuNing", "SUCCESS", "SETCase");
	test_case(connfd, "GET Name", "LiuNing", "GETCase");
	test_case(connfd, "MOD Name LeiLuo", "SUCCESS", "MODCase");
	test_case(connfd, "GET Name", "LeiLuo", "GETCase");
...
void rbtree_testcase(int connfd) {
	...
	test_case(connfd, "RSET Name LiuNing", "SUCCESS", "SETCase");
	test_case(connfd, "RGET Name", "LiuNing", "GETCase");
	test_case(connfd, "RMOD Name LeiLuo", "SUCCESS", "MODCase");
	test_case(connfd, "RGET Name", "LeiLuo", "GETCase");
...
void rbtree_testcase_5w_node(int connfd) {
	...
	for (i = 0;i < count;i ++) {
		...
		snprintf(cmd, 128, "RSET Name%d LiuNing%d", i, i);
	...
	for (i = 0;i < count;i ++) {
		...
		snprintf(cmd, 128, "RDEL Name%d LiuNing%d", i, i);
...
void hash_testcase(int connfd) {
	...
	test_case(connfd, "HSET Name LiuNing", "SUCCESS", "HSETCase");
	test_case(connfd, "HGET Name", "LiuNing", "HGETCase");
	test_case(connfd, "HMOD Name LeiLuo", "SUCCESS", "HMODCase");
	test_case(connfd, "HGET Name", "LeiLuo", "HGETCase");
...
void hash_testcase_5w_node(int connfd) {
	...
	for (i = 0;i < count;i ++) {
		...
		snprintf(cmd, 128, "HSET Name%d LiuNing%d", i, i);
		test_case(connfd, cmd, "SUCCESS", "SETCase");
	...
	for (i = 0;i < count;i ++) {
		...
		snprintf(cmd, 128, "HDEL Name%d LiuNing%d", i, i);
		test_case(connfd, cmd, "SUCCESS", "DELCase");
